 ...
 *
 */
void RCSwitch::switchOn(int nrToSend, int numberOfBits){
  
  this->send(dec2binWzerofill(nrToSend, numberOfBits));
  ...
  this->send(dec2binWzerofill(300, 24));
  */
